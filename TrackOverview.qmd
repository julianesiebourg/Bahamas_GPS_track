...
df <- data.frame(
  ...
  time = lubridate::ymd_hms(date_time) |> lubridate::with_tz(tzone = "America/Nassau")
  #kts = as.numeric(speed) * 1.944,
  #elevation = as.numeric(elevation)
  ) |> # convert from m/s to knots 
  arrange(time) |>
  mutate(date = lubridate::as_date(time), .before = time) |>
...
-   Markers are the positions at the full hour for approximate logbook entries.
